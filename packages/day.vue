<template lang="html">
  <div :val="value_">
    <div class="mines">
      <el-radio v-model="type" label="1" size="mini" border style="width:120px;">每日</el-radio>
    </div>
    <div class="mines">
    ...
    <div class="mines">
      ...
      <span style="margin-left: 20px; margin-right: 10px;">从</span>
    ...
    <div class="mines">
      <el-radio v-model="type" label="8" size="mini" border style="width:120px;">工作日</el-radio>
...
export default {
  ...
  computed: {
    value_() {
      let result = handleTimeType(this, this.type, 'day')
      return result
    }
  },
  watch: {
